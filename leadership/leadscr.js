...
const dom = {
    ...
    prevleader_root: document.querySelector(".prevleaders"),
}
...
const prevleaders = [
    {
        ...
        image: "previous/director-johnson.png"
    },
    {
        name: "Dragonworm",
    ...
    },
    {
        ...
        image: "previous/volker.png"
    }
]

function render(list, root) {
    for (let leader of list) {
...
render(leadership, dom.leader_root)
render(prevleaders, dom.prevleader_root)
